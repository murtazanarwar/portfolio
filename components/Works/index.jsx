...
const Works = () => {
    return (
        <div className="max-w-6xl m-auto p-4 pt-8 px-2 sm:pt-20" id="projects">
            <h1 className="text-4xl text-teal-500 font-bold sm:text-5xl">#Latest Projects</h1>
            <p className="text-sm text-teal-500 font-semibold mt-4 mb-8 leading-6">
                I build and deploy full-stack applications with a focus on clean code and robust architecture.
            </p>
