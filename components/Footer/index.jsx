        ...
        <div className="px-2">
            <div className="py-4 border-b border-b-gray-800 flex justify-between items-center max-w-6xl m-auto">
                <h2 className="text-md text-white font-semibold">
                    <a href="">Murtaza Narwarwala</a>
                </h2>
                <ul className="flex justify-center items-center gap-3">
                    <li className="text-white text-sm" title="LinkedIn">
                        <a href="https://www.linkedin.com/in/murtaza-narwarwala" className="ease-in-out duration-150 hover:text-teal-500">
                            <FaLinkedinIn />
                        </a>
                    </li>
                    <li className="text-white text-sm" title="Codepen">
                        <a href="https://codepen.io/Murtaza-Narwarwala" className="ease-in-out duration-150 hover:text-teal-500">
                            <FaCodepen />
                        </a>
                    </li>
                    <li className="text-white text-sm" title="GitHub">
                        <a href="https://github.com/murtazanarwar" className="ease-in-out duration-150 hover:text-teal-500">
                            <FaGithub />
                        </a>
                    </li>
                    <li className="text-white text-sm" title="Twitter">
                        <a href="https://x.com/NarwarMurtaza" className="ease-in-out duration-150 hover:text-teal-500">
                            <FaTwitter />
                        </a>
                    </li>
                </ul>
            ...
            <div className="py-8 flex flex-col gap-4 justify-between items-center max-w-6xl m-auto sm:flex-row sm:gap-0">
                ...
                <h5 className="text-white font-initial text-sm">&copy; 2025 - Murtaza Narwarwala. All Rights Reserved.</h5>
            </div>
        </div>
    );
}
